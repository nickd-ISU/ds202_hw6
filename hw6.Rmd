...
bisSimple %>%
  ...
  geom_text(aes(color=category),size=bisSimple$size,hjust=0,vjust=0,check_overlap = TRUE) +
...
## Description:  
This is my final result. After many many attempts I could not get to displaying the intelligence of the dog or
making a legend for the size of the dog. However, I was able to show...
1) The Breed through geom_text()
